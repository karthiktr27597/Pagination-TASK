...
console.log('maxRigth',maxRight);
  ...
  for(var page=maxLeft; page<=maxRight; page++) {
     wrapper.innerHTML = wrapper.innerHTML + `<button id=${page} onclick="btn(this)" class="page btn btn-sm btn-info">${page}</button>`
  }
  ...
  if(state.page != pages)
  {
    wrapper.innerHTML = wrapper.innerHTML + `<button id=${Number(state.page)+1} onclick="btn(this)" class="page btn btn-sm btn-info">Next</button>`+`<button id=${pages} onclick="btn(this)" class="page btn btn-sm btn-info">Last</button>`
  }
